    ...
    def on_plot_click(self, event):
        ...
        if event.inaxes is not None and event.button == 1:
            ...
            for ax in plt.gcf().get_axes():
                ...
                # Add the value at the intersection of a cursor and a curve
                y_values = self.get_y_value(ax, self.target_x_value)
                x_values_sec = self.x_series[int(self.target_x_value)]
                self.update_bottom_right_text(ax, x_values_sec, y_values)
